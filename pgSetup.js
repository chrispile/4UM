...
var pgSetup = new function() {
    ...
    this.connect = function() {
        ...
        pgClient.query("CREATE TABLE IF NOT EXISTS Subscribes(uid integer, sid integer, PRIMARY KEY(uid, sid))");
        pgClient.query("CREATE TABLE IF NOT EXISTS Voted(uid integer, pid integer, vote integer, PRIMARY KEY(uid, pid))");
